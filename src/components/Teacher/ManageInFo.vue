          ...
          <el-row>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="姓名">
                <el-input v-model="infoData.name" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="性别">
                <el-input v-model="infoData.sex" readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="出生日期">
                <el-input v-model="infoData.birth" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="政治面貌">
                <el-input v-model="infoData.political" readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="籍贯">
                <el-input v-model="infoData.nativePlace" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="联系电话">
                <el-input v-model="infoData.tel" readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="身份证号">
                <el-input v-model="infoData.code" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="家庭住址">
                <el-input v-model="infoData.address" readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
          <el-row>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="微信号">
                <el-input v-model="infoData.wechat" readonly></el-input>
              </el-form-item>
            </el-col>
            <el-col style="width: 40%;margin-left: 5%">
              <el-form-item label="QQ">
                <el-input v-model="infoData.qq" readonly></el-input>
              </el-form-item>
            </el-col>
          </el-row>
        </el-form>
...
export default {
  ...
  methods: {
    findAllStudentsByTeacher() {
      axios.post('/teacher/findAllStudentsByTeacher', {
    ...
    searchStudent() {
      axios.post('/teacher/findStudentsLike', {
    ...
    openInfo(row) {
      ...
      axios.post('/teacher/findInfoById',{
        id: row.id
      }).then(res=>{
        if (res.data.code != 0)
          return this.$message.error(res.data.msg)
    ...
    complete(){
      axios.post('/teacher/completeInfo',{
        id: this.id
      }).then(res=>{
        if (res.data.code!=0)
          return this.$message.error(res.data.msg)
    ...
    resetPassword(row){
      axios.post('/teacher/resetStuPwd',{
        id: row.id
      }).then(res=>{
        if (res.data.code!=0)
          return this.$message.error(res.data.msg)
