...
export default {
  ...
  methods: {
    findAllStudentsByTeacher() {
      axios.post('/teacher/findFamilyByTeacherNo', {
    ...
    searchStudent() {
      axios.post('/teacher/findStudentsByFamily', {
    ...
    openInfo(row) {
      ...
      axios.post('/teacher/findFamilyById',{
        id: row.id
      }).then(res=>{
        if (res.data.code != 0)
          return this.$message.error(res.data.msg)
    ...
    complete(){
      axios.post('/teacher/completeFamily',{
        id: this.id
      }).then(res=>{
        if (res.data.code!=0)
          return this.$message.error(res.data.msg)
