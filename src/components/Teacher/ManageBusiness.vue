...
export default {
  ...
  methods: {
    findAllStudentsByTeacher() {
      axios.post('/teacher/findBusinessByTeacherNo', {
    ...
    searchStudent() {
      axios.post('/teacher/findStudentsByBusiness', {
    ...
    openInfo(row) {
      ...
      axios.post('/teacher/findBusinessById',{
        id: row.id
      }).then(res=>{
        if (res.data.code != 0)
          return this.$message.error(res.data.msg)
    ...
    complete(){
      axios.post('/teacher/completeBusiness',{
        id: this.id
      }).then(res=>{
        if (res.data.code!=0)
          return this.$message.error(res.data.msg)
    ...
    fail(){
      axios.post('/teacher/failBusiness',{
        id: this.id,
        note: this.note
      }).then(res=>{
        if (res.data.code!=0)
